...
extension SDKSynchronizerClient: TestDependencyKey {
    static let testValue = Self(
        ...
        reconcileUnrecordedMigrationBroadcasts: unimplemented("\(Self.self).reconcileUnrecordedMigrationBroadcasts", placeholder: false),
        ...
        migrationPrivacySyncBufferDuration: unimplemented("\(Self.self).migrationPrivacySyncBufferDuration", placeholder: 0),
...
extension SDKSynchronizerClient {
    static let noOp = Self(
        ...
        reconcileUnrecordedMigrationBroadcasts: { _ in false },
        ...
        migrationPrivacySyncBufferDuration: { 0 },
...
extension SDKSynchronizerClient {
    ...
    importAccount: @escaping @Sendable (String, [UInt8]?, Zip32AccountIndex?, AccountPurpose, String, String?, BlockHeight?) async throws -> AccountUUID? = { _, _, _, _, _, _, _ in nil },
        ...
        reconcileUnrecordedMigrationBroadcasts: @escaping @Sendable (AccountUUID) async throws -> Bool = { _ in false },
        ...
        migrationPrivacySyncBufferDuration: @escaping @Sendable () -> TimeInterval = { 0 },
        ...
        SDKSynchronizerClient(
            ...
            reconcileUnrecordedMigrationBroadcasts: reconcileUnrecordedMigrationBroadcasts,
            ...
            migrationPrivacySyncBufferDuration: migrationPrivacySyncBufferDuration,
